...
# Find the mean of sequence ( 29 , 11 , 11 , 3 , 9 , 6 ) 
...
for i in tqdm(range(num_samples)):
    ...
    line3 = "Find the mean of sequence ( "+listToStr+" ) "#+" with length "+str(randLenOfSeq)
    question = re.sub('\s+', ' ', line3) + "\n"

    tempAns = sum(listOfrandomNumbers) / len(listOfrandomNumbers)
