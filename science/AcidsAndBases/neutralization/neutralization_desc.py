...
def type1():
    ...
    v4 = "we know that n1 x v1 = n2 x v2 and also n1 x v3 = n2 x v4, by dividing these two equations we have v1/v3 = v2/v4 => v4 = (v2 x v3)/v1 => v4 = (" + str(v2) + " x " + str(v3) + ")/" + str(v1) + " => v4 = " + str(calculation(v1, v2, v3)) + " ml\n"
    return q,v4
