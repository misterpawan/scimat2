...
def type1() :
    ...
    avg_mass =  "if p1 is percentage of m1 mass sample and p2 is percentage of m2 mass sample then, average atomic mass = (p1/100)xm1 + (p2/100)xm2 = (" + str(p1) + "/100)x" + str(a1) + " (" + str(p2) + "/100)x" + str(a2) + " = " + str(calculation_1(a1, p1, a2, p2)) + "u\n"
    return q, avg_mass
...
def type2() :
    ...
    avg_mass = "if p1 is percentage of m1 mass sample, p2 is the percentage of m2 mass sample and p3 is percentage of m3 mass sample then, average atomic mass = (p1/100)xm1 + (p2/100)xm2 + (p3/m3)x100 = (" + str(p1) + "/100)x" + str(a1) + " (" + str(p2) + "/100)x" + str(a2) + " (" + str(p3) + "/100)x" + str(a3) + " = " + str(calculation_2(a1, p1, a2, p2, a3, p3)) + "u\n"
    return q, avg_mass
...
def type3() :
    ...
    percentages = "let p1, p2 are the required percentages of m1 and m2 masses respectively, we have p2 = 100 - p1, we know that average atomic mass(avg_m) = (p1/100)xm1 + (p2/100)xm2 => avg_m = (p1/100)xm1 + (100-p1/100)xm2 => p1 = ((avg_m - m2)x100)/(m1 - m2) => p1 = " + str(p1) + "%" + " and p2 = 100 - p1 = " + str(p2) + "%\n"
