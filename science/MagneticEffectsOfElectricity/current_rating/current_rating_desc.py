...
def type1():
    ...
    if P/V-I > 0.01:
        a = "it will be safer if p/v-i is less than or equal to 0.01. now p/v-i = " + str(P) + "/" + str(V) + " - " + str(I) + " = " + str(round(P/V-I,3)) + ". so, it will not be safe for longer time.\n"
    else:
        a = "it will be safer if p/v-i is less than or equal to 0.01. now p/v-i = " + str(P) + "/" + str(V) + " - " + str(I) + " = " + str(round(P/V-I,3)) + ". so, it will safe for longer time.\n"
    return q,a
...
def type2():
    ...
    a = "the minimum current rating required = p/v = " + str(P) + "/" + str(V) + " = " + str(round(P/V,1))+" ampere\n"
    return q,a
