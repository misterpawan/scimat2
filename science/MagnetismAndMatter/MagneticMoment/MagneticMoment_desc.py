...
def type1() :
    ...
    a1 = "if b is magnetic field strength, t is torque due to that magnetic moment, d is angle between axis of magnet and magnetic field and m is magnetic moment then t = m x b x sin(d) => m = t/(b x sin(d)) => m = "
    a = a1 + "{:.2e}".format(cal1(t, b, d)) + " joule/tesla\n"
    return q,a
...
def type2() :
    ...
    a1 = "if b is magnetic field strength, t is torque due to that magnetic moment, d is angle between axis of magnet and magnetic field and m is magnetic moment then t = m x b x sin(d) => t = "
    a = a1 + "{:.2e}".format(cal2(m, b, d)) + " newton-m\n"
    return q,a
