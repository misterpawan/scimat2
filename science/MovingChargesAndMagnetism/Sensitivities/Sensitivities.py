...
def type1() :
    ...
    a = "Ratio of current sensitivity of M1 to M2 is " + str(cal1(n1,a1, r1, k1, b1, n2, a2, r2, b2, k2)) + "\n"
    return q,a
...
def type2() :
    ...
    a = "Ratio of voltage sensitivity of M1 to M2 is " + str(cal2(n1,a1, r1, k1, b1, n2, a2, r2, b2, k2)) + "\n"
    return q,a
