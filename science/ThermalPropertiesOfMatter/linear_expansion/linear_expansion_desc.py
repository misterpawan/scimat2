...
def type1() :
    ...
    a = "for linear expansion we know that, change in length (d(l)) = alpha x l1 x d(t) => required temp(t) = t1 + ((d(l))/(alpha*l1)) => t = " + str(t1) + " + ((" + str(d2) + " - " + str(d1) + ")/(" + str(a) + " x " + str(d1) + ")) => t = " + str(cal1(t1,d1,d2,a)) + " degree c\n"
    return q,a
